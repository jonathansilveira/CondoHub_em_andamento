...
public class _08_N1_Assistente extends javax.swing.JFrame {
...
// Variáveis globais  
    ...
    public _08_N1_Assistente(String usuario, String cargo, String id) {
...
// Ao selecionar dados na tabela
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(_08_N1_Assistente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new _08_N1_Assistente().setVisible(true);
            }
        });
    }
