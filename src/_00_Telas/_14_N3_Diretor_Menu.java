...
public class _14_N3_Diretor_Menu extends javax.swing.JFrame {
...
// Variáveis globais    
    ...
    public _14_N3_Diretor_Menu(java.awt.Frame parent, boolean modal, String usuario, String cargo, String id) {
    ...
    public _14_N3_Diretor_Menu(String usuario, String cargo, String id) {
        initComponents(); // Inicialização
        setIcon(); // Classe setIcon, abre a tela com icon especificado
        Move(); // Classe Move, para movimentação da janela 
...
// Classe que permite a movimentação da janela arrastando com o mouse
    ...
    private void initComponents() {
        ...
        btn_propriedades = new javax.swing.JButton();
        lbl_id = new javax.swing.JLabel();
        btn_relatorios1 = new javax.swing.JButton();
        ...
        Panel_Right.add(btn_lista, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 410, 170, 40));

        btn_relatorios.setBackground(new java.awt.Color(0, 102, 102));
        btn_relatorios.setFont(new java.awt.Font("Segoe UI", 1, 16)); // NOI18N
        btn_relatorios.setForeground(new java.awt.Color(255, 255, 255));
        btn_relatorios.setText("Agrotóxicos");
        btn_relatorios.setBorderPainted(false);
        btn_relatorios.setFocusPainted(false);
        btn_relatorios.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        btn_relatorios.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btn_relatoriosActionPerformed(evt);
            }
        });
        Panel_Right.add(btn_relatorios, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 330, 170, 40));

        btn_propriedades.setBackground(new java.awt.Color(0, 102, 102));
        btn_propriedades.setFont(new java.awt.Font("Segoe UI", 1, 16)); // NOI18N
        btn_propriedades.setForeground(new java.awt.Color(255, 255, 255));
        btn_propriedades.setText("Relatórios");
        btn_propriedades.setBorderPainted(false);
        btn_propriedades.setFocusPainted(false);
        btn_propriedades.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        btn_propriedades.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btn_propriedadesActionPerformed(evt);
            }
        });
        Panel_Right.add(btn_propriedades, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 410, 170, 40));
        ...
        btn_relatorios1.setBackground(new java.awt.Color(0, 102, 102));
        btn_relatorios1.setFont(new java.awt.Font("Segoe UI", 1, 16)); // NOI18N
        btn_relatorios1.setForeground(new java.awt.Color(255, 255, 255));
        btn_relatorios1.setText("Fertilizantes");
        btn_relatorios1.setBorderPainted(false);
        btn_relatorios1.setFocusPainted(false);
        btn_relatorios1.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        btn_relatorios1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btn_relatorios1ActionPerformed(evt);
            }
        });
        Panel_Right.add(btn_relatorios1, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 330, 170, 40));
    ...
    private void btn_listaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_listaActionPerformed
        ...
        new _15_N3_Diretor(usuario, cargo, id).setVisible(true);
        dispose();
    }//GEN-LAST:event_btn_listaActionPerformed

    private void btn_propriedadesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_propriedadesActionPerformed
        String usuario = lbl_nome.getText();
        String cargo = lbl_cargo.getText();
        String id = lbl_id.getText();
        new _19_N3_Diretor(usuario, cargo, id).setVisible(true);
        dispose();
    }//GEN-LAST:event_btn_propriedadesActionPerformed
    ...
    private void btn_relatorios1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_relatorios1ActionPerformed
        String usuario = lbl_nome.getText();
        String cargo = lbl_cargo.getText();
        String id = lbl_id.getText();
        new _17_N3_Diretor(usuario, cargo, id).setVisible(true);
        dispose();
    }//GEN-LAST:event_btn_relatorios1ActionPerformed
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(_14_N3_Diretor_Menu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new _14_N3_Diretor_Menu().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JButton btn_propriedades;
    private javax.swing.JButton btn_relatorios;
    private javax.swing.JButton btn_relatorios1;
