...
public class _20_N3_Diretor extends javax.swing.JFrame {

// Variáveis globais  
    private int mouseX, mouseY;

    public _20_N3_Diretor(String usuario, String cargo, String id) {
...
// Classe que permite a movimentação da janela arrastando com o mouse
    ...
    private void initComponents() {
        ...
        lbl_grafico.setIcon(new javax.swing.ImageIcon(getClass().getResource("/_02_Imagens/Gráfico_5.jpg"))); // NOI18N
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(_20_N3_Diretor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new _20_N3_Diretor().setVisible(true);
            }
        });
    }
