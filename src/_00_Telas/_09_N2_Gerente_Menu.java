...
public class _09_N2_Gerente_Menu extends javax.swing.JFrame {
...
// Variáveis globais    
    ...
    public _09_N2_Gerente_Menu(java.awt.Frame parent, boolean modal, String usuario, String cargo, String id) {
    ...
    public _09_N2_Gerente_Menu(String usuario, String cargo, String id) {
        initComponents(); // Inicialização
        setIcon(); // Classe setIcon, abre a tela com icon especificado
        Move(); // Classe Move, para movimentação da janela 
...
// Classe que permite a movimentação da janela arrastando com o mouse
    ...
    private void btn_relatoriosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_relatoriosActionPerformed
        ...
        String cargo = lbl_cargo.getText();
        String id = lbl_id.getText();
        new _11_N2_Gerente(usuario, cargo, id).setVisible(true);
        dispose();
    ...
    private void btn_relatorios1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_relatorios1ActionPerformed
        ...
        String cargo = lbl_cargo.getText();
        String id = lbl_id.getText();
        new _13_N2_Gerente(usuario, cargo, id).setVisible(true);
        dispose();
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(_09_N2_Gerente_Menu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new _09_N2_Gerente_Menu().setVisible(true);
            }
        });
    }
