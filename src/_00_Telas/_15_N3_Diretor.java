...
public class _15_N3_Diretor extends javax.swing.JFrame {
...
// Variáveis globais  
    ...
    public _15_N3_Diretor(String usuario, String cargo, String id) {
...
// Classe pegar dados do usuário
    ...
    private void initComponents() {
        ...
        Panel_Right.add(btn_excluir, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 520, 100, 35));
...
// Ao selecionar dados na tabela
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(_15_N3_Diretor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new _15_N3_Diretor().setVisible(true);
            }
        });
    }
