...
public class _13_N2_Gerente extends javax.swing.JFrame {
    
// Variáveis globais  
    private int mouseX, mouseY;

    public _13_N2_Gerente(String usuario, String cargo, String id) {
...
// Classe que permite a movimentação da janela arrastando com o mouse
    ...
    private void initComponents() {
        ...
        lbl_grafico.setIcon(new javax.swing.ImageIcon(getClass().getResource("/_02_Imagens/Gráfico_2.jpg"))); // NOI18N
        Panel_Main.add(lbl_grafico, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 70, 760, 460));
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(_13_N2_Gerente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new _13_N2_Gerente().setVisible(true);
            }
        });
    }
