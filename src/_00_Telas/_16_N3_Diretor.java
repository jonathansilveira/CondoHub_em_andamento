...
public class _16_N3_Diretor extends javax.swing.JFrame {
    
// Variáveis globais  
    private int mouseX, mouseY;

    public _16_N3_Diretor(String usuario, String cargo, String id) {
...
// Classe que permite a movimentação da janela arrastando com o mouse
    ...
    private void btn_proximoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_proximoActionPerformed
        ...
        new _18_N3_Diretor(usuario, cargo, id).setVisible(true);
        dispose();
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(_16_N3_Diretor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new _16_N3_Diretor().setVisible(true);
            }
        });
    }
