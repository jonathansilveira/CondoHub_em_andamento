...
public class _19_N3_Diretor extends javax.swing.JFrame {
    
// Variáveis globais  
    private int mouseX, mouseY;

    public _19_N3_Diretor(String usuario, String cargo, String id) {
...
// Classe que permite a movimentação da janela arrastando com o mouse
    ...
    private void initComponents() {
        ...
        lbl_grafico.setIcon(new javax.swing.ImageIcon(getClass().getResource("/_02_Imagens/Gráfico_4.jpg"))); // NOI18N
        Panel_Main.add(lbl_grafico, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 60, 730, 450));
    ...
    private void btn_proximoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_proximoActionPerformed
        ...
        new _20_N3_Diretor(usuario, cargo, id).setVisible(true);
        dispose();
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(_19_N3_Diretor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new _19_N3_Diretor().setVisible(true);
            }
        });
    }
