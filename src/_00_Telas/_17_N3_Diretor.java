...
public class _17_N3_Diretor extends javax.swing.JFrame {
    
// Variáveis globais  
    private int mouseX, mouseY;

    public _17_N3_Diretor(String usuario, String cargo, String id) {
...
// Classe que permite a movimentação da janela arrastando com o mouse
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(_17_N3_Diretor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new _17_N3_Diretor().setVisible(true);
            }
        });
    }
