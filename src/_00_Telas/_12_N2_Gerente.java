...
public class _12_N2_Gerente extends javax.swing.JFrame {
    
// Variáveis globais  
    private int mouseX, mouseY;

    public _12_N2_Gerente(String usuario, String cargo, String id) {
...
// Classe que permite a movimentação da janela arrastando com o mouse
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(_12_N2_Gerente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new _12_N2_Gerente().setVisible(true);
            }
        });
    }
